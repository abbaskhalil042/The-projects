const ChatSec = () => {
  return (
    <div className="flex flex-col w-1/2 h-screen shadow-lg rounded-md overflow-hidden">
      {/* Top section (User info) */}
      <div className="user-name bg-slate-600 flex gap-2 items-center px-2 shadow-lg sticky top-0 z-10">
        <img
        ...
        <div className="flex flex-col">
          <h2 className="text-2xl font-medium text-white">Anakin Skywalker</h2>
      ...
      <div className="bg-slate-600 p-1 mt-8 flex gap-2 items-center fixed bottom-0 w-1/2 ">
        <input
          type="text"
